...
# Read the WHSA2 buffer
ds = ogr.Open("M:/Data/Ghana/WHSA/whsa2_100m_buffer.shp")

###############################################################################
# Accra VIS Imagery
ds = gdal.Open("M:/Data/Ghana/Imagery/Accra_VIS/Ghana_VIS_masked_geotiff.tif")
image_export_filename = data_dir + 'VIS_image.npz'

###############################################################################
# Accra NDVI images
#ds = gdal.Open("M:/Data/Ghana/Imagery/Accra_NDVI/cloud_masked_qb02_ndvi_ge120_v02.tif")
#image_export_filename = data_dir + 'Quickbird_2002_NDVI_thresholded.npz'
ds = gdal.Open("M:/Data/Ghana/Imagery/Accra_NDVI/cloud_masked_qb10_ndvi_ge120_v02.tif")
